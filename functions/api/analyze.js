...
3. Pay close attention to who breaks silences (ghost breakers) and the humor balance. Incorporate these into your analysis.
4. The VALUES inside the JSON MUST be written in the requested Output Language (${language || 'english'}). If Hinglish is requested, use conversational Hindi written in the English alphabet (e.g., 'Bhai kya kar raha hai'). Make it gen-z, witty, and brutal.`;
